            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 items-start">
                <div className="order-2 md:order-1">
                     <SectionHeading
                        ...
                        title="受け継がれる、誠実な手仕事。"
                        subtitle="創業から半世紀以上、私たちは一貫して「木」と向き合い、その可能性を追求してきました。良質な素材、確かな技術、そして細部へのこだわり。富永建具は、お客様一人ひとりの想いを形にし、時代を超えて愛されるものづくりを目指しています。"
                        actions={
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 items-start">
                ...
                <div>
                    <SectionHeading
                        ...
                        title="空間に、最適な解を。"
                        subtitle="個人のお客様のオーダーメイド家具から、法人のお客様の空間づくりまで。私たちは、設計、製造、施工を一貫して行い、あらゆるニーズに最適なソリューションを提供します。建具一枚から、空間全体のプロデュースまでお任せください。"
                        actions={
